...
<script>
import Initiative_2 from "~/components/Main/Initiative_2.vue";

import Initiative_challenge from "~/components/Main/initiative_challenge.vue";
export default {
  name: "IndexPage",
  components: { Initiative_2, Initiative_challenge },
};
</script>
